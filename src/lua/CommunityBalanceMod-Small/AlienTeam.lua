function AlienTeam:InitTechTree()
    ...
    -- Add the new upgrade nodes to the tech tree
    self.techTree:AddUpgradeNode(kTechId.GorgeEgg, kGorgeEggBiomass)
    self.techTree:AddUpgradeNode(kTechId.LerkEgg, kLerkEggBiomass)
    self.techTree:AddUpgradeNode(kTechId.FadeEgg, kFadeEggBiomass)
    self.techTree:AddUpgradeNode(kTechId.OnosEgg, kOnosEggBiomass)
    ...
    self.techTree:AddResearchNode(kTechId.MetabolizeHealth, kTechId.BioMassFive, kTechId.MetabolizeEnergy,
        kTechId.AllAliens)
